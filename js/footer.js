 ...
 * The markup and styles below are an exact copy of the Home ("Inicio") page footer.
...
(function () {
   ...
   var FOOTER_CSS = 'footer{background:#1a1a1a;color:#fff;padding:60px 0 30px}' +
         ...
         '.foot-social img{width:26px;filter:brightness(0) invert(1) opacity(.6);transition:filter .2s}' +
         '.foot-social a:hover img{filter:brightness(0) invert(1) opacity(.85)}' +
         '.foot-social .li-foot{display:inline-block;width:26px;height:26px;background-color:#fff;opacity:.6;-webkit-mask-image:url(/assets/icons/linkedin-icon.png);mask-image:url(/assets/icons/linkedin-icon.png);-webkit-mask-size:contain;mask-size:contain;-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;-webkit-mask-position:center;mask-position:center;-webkit-mask-mode:luminance;mask-mode:luminance;transition:opacity .2s}' +
         '.foot-social a:hover .li-foot{opacity:.85}' +
